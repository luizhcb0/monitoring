...
device1 = Device.create(user_ids: [2], serial:"1111-1111-01", model: 0, address: "http://192.168.0.22")
device2 = Device.create(user_ids: [2], serial:"1111-1111-02", model: 0, address: "http://192.168.0.22")
device3 = Device.create(user_ids: [2], serial:"1111-1111-03", model: 0, address: "http://192.168.0.22")
device4 = Device.create(user_ids: [2], serial:"1111-1111-04", model: 0, address: "http://192.168.0.22")
device5 = Device.create(user_ids: [3], serial:"1111-1111-05", model: 0, address: "http://192.168.0.22")
device6 = Device.create(user_ids: [3], serial:"1111-1111-06", model: 0, address: "http://192.168.0.22")
device7 = Device.create(user_ids: [3], serial:"1111-1111-07", model: 0, address: "http://192.168.0.22", dimension: (Dimension.create(x: 2, y: 0.6, z: 0.6, volume: 1000)))
device8 = Device.create(user_ids: [3], serial:"1111-1111-08", model: 0, address: "http://192.168.0.22", dimension: (Dimension.create(x: 2, y: 0.5, z: 0.6, volume: 500)))
...
# Dimension.create(x: 2, y: 0.5, z: 0.6, volume: 500, device_id: 8)
#
